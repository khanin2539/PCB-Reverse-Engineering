...
img = cv2.imread("PCB sample.PNG", 0)
_, th1 = cv2.threshold(img, 45, 251, cv2.THRESH_BINARY) # create a threshold level such that 1st arg is image source, 2nd is threshold value, 3rd is the max value, 4th is threshold type in this case binary as completely black and completely white
...
#Reference: pknowledge, June 19th, 2019, Find_and_Draw_Contours_using_OpenCV_Python.py, version2, https://gist.github.com/pknowledge/af2cfb0753abe45c563188794773618f